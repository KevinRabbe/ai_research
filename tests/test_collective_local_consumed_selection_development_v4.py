...
from plural_cognition.collective.consumed_selection_development_v4 import DEVELOPMENT_PROTOCOL_SHA256_V4
from plural_cognition.collective.local_consumed_selection_development_v4 import (
...
def test_v4_runner_uses_exactly_one_terminal_lf_transport_strip() -> None:
...
def test_v4_development_configuration_identity_changes_with_protocol() -> None:
